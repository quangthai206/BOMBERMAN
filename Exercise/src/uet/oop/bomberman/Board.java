...
public class Board implements IRender {
	...
	public static BackMusic backMusic = new BackMusic();
	...
	public void render(Screen screen) {
		...
		int x0 = Screen.xOffset >>4; /*Screen.xOffset >> 4;*/ //tile precision, -> left X
	...
	public void loadLevel(int level) {
		if (level % 2 != 0)
			backMusic.playBackOddMusic();
		else
			backMusic.playBackEvenMusic();
		_time = Game.TIME;
		_screenToShow = 2;
